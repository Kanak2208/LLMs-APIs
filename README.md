...
**Idea #15:** give a job role → get 10 tailored interview questions with sample answers.
...
3. Put your key in `.env`:  `GROQ_API_KEY=gsk_...`
4. Run the notebook, or launch the app:  `streamlit run interview_question_app.py`
